...
class ItemService implements ItemServiceInterface {
  ...
  Future<List<Item>?> getOnDemandProducts() async {
    return await itemRepositoryInterface.getOnDemandProducts();
  }
  ...
  @override
  Future<double> setQuantity(bool isIncrement, bool moduleStock, double? stock, double qty, int? quantityLimit, {bool getxSnackBar = false}) async{
    double quantity = qty;
    if (isIncrement) {
